...
if (isset($_POST['bSimpan'])) 
{
    ...
    $sql = "SELECT * FROM tbl_dosen WHERE id_dosen = '$user_id' ";
    ...
    if (password_verify($password_lama, $data->password))
    {
        ...
        if ($password_baru == $konf_password)
        {
            ...
            $sql = "UPDATE tbl_dosen SET `password` = '$hash' WHERE id_dosen = '$user_id' ";
                ...
                <div class="card-body">
                    <form method="POST" action="">
                        <div class="form-group">
                            <input type="hidden" class="form-control" name="username" value="<?= $_SESSION['id_dosen'] ?>">
                        </div>
                        <div class="form-group">
