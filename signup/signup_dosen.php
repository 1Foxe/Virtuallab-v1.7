                        ...
                        <div class="col-lg-0">
                            <div class="p-5">
                                ...
                                <form class="user" method="POST" action="">
                                    ...
                                    <div class="form-group">
                                        <input type="number" class="form-control form-control-user" id="nik_dosen" name="nik_dosen" placeholder="NIK" />
                                    </div>
                                    <div class="form-group">
                                        <input type="email" class="form-control form-control-user" id="email_dosen" name="email_dosen" aria-describedby="emailHelp" placeholder="Email" required/>
                                    </div>
                                    <div class="form-group">
                                        <input type="number" class="form-control form-control-user" id="no_hpdosen" name="no_hpdosen" placeholder="No. Hp" required/>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" id="alamat_dosen" name="alamat_dosen" placeholder="Alamat" required/>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="text-center">
                                    ...
                                    <a class="small" href="../login/login_dosen.php">Login</a>
                                </div>
                            </div>
                        </div>
