...
if (isset($_POST["register"])) {
    ...
    if (registrasi_mahasiswa($_POST) > 0) {
                        ...
                        <div class="col-lg-0">
                            <div class="p-5">
                                ...
                                <form class="user" method="POST" action="">
                                    ...
                                    <div class="form-group">
                                        <input type="number" class="form-control form-control-user" id="nim_mhs" name="nim_mhs" placeholder="NIM" required/>
                                    </div>
                                    <div class="form-group">
                                        <input type="email" class="form-control form-control-user" id="email_mhs" name="email_mhs" aria-describedby="emailHelp" placeholder="Email" required/>
                                    </div>
                                    <div class="form-group">
                                        <input type="number" class="form-control form-control-user" id="no_hpmhs" name="no_hpmhs" placeholder="No. Hp" required/>
                                    </div>
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" id="alamat_mhs" name="alamat_mhs" placeholder="Alamat" required/>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="hidden" class="form-control form-control-user" id=" profile_img" name=" profile_img"/>
                                    <br>
                                ...
                                <div class="text-center">
                                    ...
                                    <a class="small" href="../login/login_mahasiswa.php">Login</a>
                                </div>
                            </div>
                        </div>
