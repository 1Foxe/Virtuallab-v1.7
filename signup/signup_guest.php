...
<head>
    ...
    <link rel="stylesheet" href="../assets/css/style-register-guest-pswd.css">
</head>
                            ...
                            <div class="p-5">
                                ...
                                <form class="user" method="POST" action="">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" id="username" name="username" placeholder="Full Name as Username" required/>
                                    </div>
                                    <div class="form-group">
                                        <input type="email" class="form-control form-control-user" id="email_guest" name="email_guest" aria-describedby="emailHelp" placeholder="Email" required/>
                                    </div>
                                    <div class="form-group">
                                    ...
                                    <div class="form-group">
                                        <input type="hidden" class="form-control form-control-user" id="profile_img" name="profile_img" aria-describedby="emailHelp" placeholder="Photo" required/>
                                    </div>
                                ...
                                <div class="text-center">
                                    ...
                                    <a class="small" href="../login/login_guest.php">Login</a>
                                </div>
                            </div>
                        </div>
