...
if (isset($_POST['bSimpan'])) 
{
    ...
    $sql = "SELECT * FROM tbl_mahasiswa WHERE id_mhs = '$user_id' ";
    ...
    if (password_verify($password_lama, $data->password))
    {
        ...
        if ($password_baru == $konf_password)
        {
            ...
            $sql = "UPDATE tbl_mahasiswa SET `password` = '$hash' WHERE id_mhs = '$user_id' ";
                ...
                <div class="card-body">
                    <form method="POST" action="">
                        <div class="form-group">
                            <input type="hidden" class="form-control" name="username" value="<?= $_SESSION['id_mhs'] ?>">
                        </div>
                        <div class="form-group">
                            <label for="pass_lama">Password Lama</label>
                            <input type="text" class="form-control" id="pass_lama" name="pass_lama" required>
                            <span id="pass1"><i class="fa-solid fa-eye" id="eye1" onclick="toggle1()"></i></span>
                        </div>
                        <div class="form-group">
                            <label for="pass_baru">Password Baru</label>
                            <input type="text" class="form-control" id="pass_baru" name="pass_baru" required>
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="konfirmasi_pass" name="konfirmasi_pass" required>
                            <span id="pass3"><i class="fa-solid fa-eye" id="eye3" onclick="toggle3()"></i></span>
                        </div>
                        <button type="submit" name="bSimpan" class="btn btn-primary">Simpan</button>
                        <a href="mhs.php" class="btn btn-danger">Kembali</a>
                    </form>
