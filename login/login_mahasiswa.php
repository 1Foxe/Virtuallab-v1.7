...
session_start();
// die(var_dump(!isset($_SESSION["id_mhs"])));
if (isset($_POST['submit'])) {
  $username = $_POST['username'];
  $password = $_POST['password'];

  //Proses Login Dosen
  $query = "SELECT * FROM tbl_mahasiswa WHERE username = '$username'";
  ...
  if (mysqli_num_rows($eksekusi) == 1) {
    ...
    if (!password_verify($password, $data['pass'])) {
      ...
      echo "<script type='text/javascript'>
            ...
            window.setTimeout(function(){
              document.location='login_mahasiswa.php';
            }, 1000);
            </script>";
      exit;
    }
    ...
    echo "<script type='text/javascript'>
          setTimeout(function() {
			      Swal.fire({
			      	title: 'Login Sebagai Mahasiswa Berhasil',
			      	icon: 'success',
			      	timer: 2000,
              showConfirmButton: false
			      });
                ...
                <div class="p-5">
                  ...
                  <form class="user" method="POST" action="">
                    ...
                    <div class="form-group">
                      ...
                      <span id="fitur4"><i class="fa-solid fa-eye" id="eye" onclick="toggle()"></i></span>
                    </div>
                    <div class="form-group">
                  ...
                  <div class="text-center">
                    <a class="small" href="../forgot_password/forgot_pass_mhs.php">Forgot Password?</a>
                    <br>
                    <br>
                    <div>
                      <a class="small" href="../signup/signup_mahasiswa.php">Sign Up</a>
                    </div>
                  </div>
                </div>
              </div>
