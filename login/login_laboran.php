...
if (isset($_POST['submit'])) {
  ...
  //Proses Login Laboran
  $query = "SELECT * FROM tbl_laboran WHERE username = '$username'";
  ...
  if (mysqli_num_rows($eksekusi) == 1) {
    ...
    if (!password_verify($password, $data['pass'])) {
      ...
      echo "<script type='text/javascript'>
            ...
            window.setTimeout(function(){
              document.location='login_laboran.php';
            }, 1000);
            </script>";
      exit;
    }
    ...
    session_start();
    // bikin role nya
    $_SESSION["id_laboran"] = $data["id_laboran"];
    ...
    echo "<script type='text/javascript'>
          setTimeout(function() {
			      Swal.fire({
			      	title: 'Login Sebagai Laboran Berhasil',
			      	icon: 'success',
			      	timer: 2000,
              showConfirmButton: false
			      });
                ...
                <div class="p-5">
                  ...
                  <form class="user" method="POST" action="">
                    ...
                    <div class="form-group">
                      ...
                      <span id="fitur3"><i class="fa-solid fa-eye" id="eye" onclick="toggle()"></i></span>
                    </div>
                    <div class="form-group">
                  ...
                  <div class="text-center">
                    <a class="small" href="../forgot_password/forgot_pass_labor.php">Forgot Password?</a>
                    <br>
                    <br>
                    <div>
                      <a class="small" href="../signup/signup_laboran.php">Sign Up</a>
                    </div>
                  </div>
                </div>
              </div>
