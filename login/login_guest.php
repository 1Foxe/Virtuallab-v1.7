...
if (isset($_POST['submit'])) {
  ...
  if (mysqli_num_rows($eksekusi) == 1) {
    ...
    if (!password_verify($password, $data['pass'])) {
      ...
      echo "<script type='text/javascript'>
            ...
            window.setTimeout(function(){
              document.location='login_guest.php';
            }, 1000);
            </script>";
      exit;
    }
    ...
    session_start();
    // bikin role nya
    $_SESSION["id_guest"] = $data["id_guest"];
    ...
    echo "<script type='text/javascript'>
          setTimeout(function() {
			      Swal.fire({
			      	title: 'Login Sebagai Guest Berhasil',
			      	icon: 'success',
			      	timer: 2000,
              showConfirmButton: false
			      });
                ...
                <div class="p-5">
                  ...
                  <form class="user" method="POST" action="">
                    ...
                    <div class="form-group">
                      ...
                      <span id="fitur2"><i class="fa-solid fa-eye" id="eye" onclick="toggle()"></i></span>
                    </div>
                    <div class="form-group">
                  ...
                  <div class="text-center">
                    <a class="small" href="../forgot_password/forgot_pass_guest.php">Forgot Password?</a>
                    <br>
                    <br>
                    <div>
                      <a class="small" href="../signup/signup_guest.php">Sign Up</a>
                    </div>
                  </div>
                </div>
              </div>
