...
if(count($_POST) > 0){
    ...
    switch ($mode) {
        ...
        if(!filter_var($email, FILTER_VALIDATE_EMAIL)){
            ...
            send_email($email);
            header("Location: forgot_pass_mhs.php?mode=enter_code");
            die;
        }
        break;
        ...
        if($result == "the code is correct"){
            ...
            header("Location: forgot_pass_mhs.php?mode=enter_password");
            die;
        }else{
            $error[] = $result;
        }
        ...
        if($password !== $password2){
            ...
            header("Location: forgot_pass_mhs.php");
            die;
        }else{   
            ...
            echo "<script type='text/javascript'>
                    setTimeout(function() {
                        Swal.fire({
                            title: 'Password Mahasiswa Berhasil Diubah',
                            icon: 'success',
                            showConfirmButton: false
                        });
                    }, 100);
                    window.setTimeout(function(){
                        document.location='../login/login_mahasiswa.php';
                    }, 1000);
                    </script>";
            die;
        }
    ...
    global $koneksi;
        ...
        $query = "INSERT INTO code_mahasiswa (email, code, expire) VALUE ('$email', '$code', '$expire')";
    ...
    global $koneksi;
        ...
        $query = "UPDATE tbl_mahasiswa SET pass = '$password' WHERE email_mhs = '$email' limit 1";
        mysqli_query($koneksi, $query);
    ...
    global $koneksi;
        ...
        $query = "SELECT * FROM tbl_mahasiswa WHERE email_mhs = '$email' limit 1";
    ...
    function is_code_correct($code){
        ...
        $query = "SELECT * FROM code_mahasiswa WHERE code ='$code' && email = '$email' && expire > '$expire' order by id desc limit 1";
        $result = mysqli_query($koneksi, $query);
        if($result){
            if(mysqli_num_rows($result) > 0)
            {
                                    ...
                                    <?php
                                        ...
                                        switch ($mode) {
                                            ...
                                            <div class="text-center">
                                                ...
                                                <form class="user" method="post" action="forgot_pass_mhs.php?mode=enter_email">
                                                ...
                                                <hr>
                                            <div class="text-center">
                                                <a class="small" href="../login/login_mahasiswa.php">Already have an account? Login!</a>
                                            </div>
                                            <?php
                                            break;
                                            ...
                                            <div class="text-center">
                                                ...
                                                <form class="user" method="post" action="forgot_pass_mhs.php?mode=enter_code">
                                                    <div class="form-group">
                                                    ...
                                                    <a href="forgot_pass_mhs.php" type="submit" class="btn btn-danger btn-user btn-block">Reset</a>
                                                </form>
                                            <hr>
                                            <?php
                                            break;
                                            ...
                                            <div class="text-center">
                                                ...
                                                <form class="user" method="post" action="forgot_pass_mhs.php?mode=enter_password">
                                                    <div class="form-group">
