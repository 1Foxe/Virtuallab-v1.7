...
if (isset($_POST['bSimpan'])) 
{
    ...
    $sql = "SELECT * FROM tbl_admin WHERE id_admin = '$user_id' ";
    ...
    if (password_verify($password_lama, $data->password))
    {
        ...
        if ($password_baru == $konf_password)
        {
            ...
            $sql = "UPDATE tbl_admin SET `password` = '$hash' WHERE id_admin = '$user_id' ";
                ...
                <div class="card-body">
                    <form method="POST" action="">
                        <div class="form-group">
                            <input type="hidden" class="form-control" name="username" value="<?= $_SESSION['id_admin'] ?>">
                        </div>
                        <div class="form-group">
