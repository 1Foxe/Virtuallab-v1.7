...
if (isset($_POST['bSimpan'])) {
    ...
    $cekMatkul = mysqli_num_rows(mysqli_query($koneksi, "SELECT * FROM tbl_matkulguest WHERE id_matkul = '$matkul' AND id_guest = '$id_guest'"));
    ...
    if($cekMatkul > 0) {
        ...
        mysqli_query($koneksi, "INSERT INTO tbl_matkulguest(id_guest, id_matkul) VALUES ('$id_guest', '$matkul') ");
        echo "<script src='./assets/js/sweetalert2/dist/sweetalert2.min.js'></script>
        <link rel='stylesheet' href='./assets/js/sweetalert2/dist/sweetalert2.min.css'>";
        echo "<script type='text/javascript'>
            setTimeout(function() {
            ...
            <div class="card border-left-primary shadow h-100 py-2">
                <div class="card-body">
                    <div class="row no-gutters align-items-center">
                        ...
                        <div class="col-auto">
                            <a href="?halaman=pilih_matkul&perihal=hapus&id=<?=$data['id_matkul']?>&id_guest=<?=$data['id_guest']?>" class="delete-enroll" data-toggle="tooltip" title="Unenroll?" data-placement="top"><i class="fa-solid fa-square-minus fa-2x "></i></a>
                        </div>
                    </div>
                </div>
            </div>
