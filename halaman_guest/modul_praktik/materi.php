...
$query = mysqli_query($koneksi, "SELECT * FROM tbl_matakuliah INNER JOIN tbl_matkulguest ON tbl_matakuliah.id_matkul = tbl_matkulguest.id_matkul WHERE tbl_matkulguest.id_matkulguest = '$id_matkulguest' AND tbl_matakuliah.id_matkul = '$id_matkul'");
?>
<div class="embed-responsive embed-responsive-16by9">
    <iframe class='embed-responsive-item' scrolling='no' src='?halaman=virtual_lab&id_matkulguest=<?= $id_matkulguest ?>' allowfullscreen></iframe>
</div>
<!-- KOMENTAR -->
<?php
if (isset($_POST['kirim'])) {
    ...
    $nama = $_POST['nama_pengirim'] . '|' . $_POST['id_matkul'] . '|' . $username . '|tbl_guest';
