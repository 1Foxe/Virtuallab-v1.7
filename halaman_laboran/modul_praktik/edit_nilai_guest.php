...
$tampil = mysqli_query($koneksi, "SELECT * FROM tbl_nilai_guest INNER JOIN tbl_attempt_guest ON tbl_nilai_guest.id_attempt_guest = tbl_attempt_guest.id_attempt_guest INNER JOIN tbl_matkulguest ON tbl_attempt_guest.id_matkulguest = tbl_matkulguest.id_matkulguest INNER JOIN tbl_mahasiswa ON tbl_matkulguest.id_guest = tbl_mahasiswa.id_guest WHERE tbl_attempt_guest.id_modul = '$id_modul'");
...
if ( $_SERVER['REQUEST_METHOD'] == 'POST' ) {
    ...
    $ubah = mysqli_query($koneksi, "UPDATE tbl_nilai_guest SET
            nilai = '$_POST[nilai]'
            WHERE id_attempt_guest = '$id_attempt'");
    if ($ubah) {
